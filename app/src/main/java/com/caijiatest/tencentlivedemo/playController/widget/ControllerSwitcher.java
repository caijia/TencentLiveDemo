...
public class ControllerSwitcher extends FrameLayout implements View.OnClickListener {
    ...
    private static final int VOLUME_TIMES = 20;
    ...
    private void init(Context context) {
        ...
        volumeProgressBar.setMax(maxVolume * VOLUME_TIMES);
        volumeProgressBar.setProgress(currentVolume * VOLUME_TIMES);
    ...
    public void startSetVolume() {
        ...
        volume = ControllerUtil.getVolume(getContext()) * VOLUME_TIMES;
    }
    ...
    public void incrementVolume(int incrementVolume) {
        ...
        ControllerUtil.setVolume(getContext(), currentVolume / VOLUME_TIMES);
    }
    ...
    public void startTimeProgress(int currentProgress, int total) {
        ...
        timeProgressBar.setMax(total);
        timeProgressBar.setProgress(currentProgress);
    }

    public void incrementTimeProgress(int progress) {
        setVisibleState(STATE_PROGRESS);
        ...
        currentTimeTv.setText(currentTime);
        timeProgressBar.setProgress(currentProgress + progress);
    }
