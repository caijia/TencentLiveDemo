	...
	public static void main(String[] args) {
		try{			
		    ...
		    String privStr = "-----BEGIN PRIVATE KEY-----\n" +
					"MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQgj8ph83AummHWWy/N5KaQ\n" +
					"zoLZgLXjZ/9E771c69eojtihRANCAARx2n/i9pJQtyL/f5nzNK/aruDZ1O9UKjmV\n" +
					"gdd9UrjTWKlElypl/XEn32lAl83a6Sjchl/V7+HOoInA06NVilna\n" +
					"-----END PRIVATE KEY-----\n";
		    
			//change public pem string to public string
			String pubStr = "-----BEGIN PUBLIC KEY-----\n" +
					"MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEcdp/4vaSULci/3+Z8zSv2q7g2dTvVCo5\n" +
					"lYHXfVK401ipRJcqZf1xJ99pQJfN2uko3IZf1e/hzqCJwNOjVYpZ2g==\n" +
					"-----END PUBLIC KEY-----\n";

            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400026978, "xiaowei2", privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400026978, "xiaojun", pubStr);
